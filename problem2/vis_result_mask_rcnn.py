...
checkpoint_file = '../work_dir/mask_rcnn/epoch_24.pth'
#img = '/work/jpma/chenxr/homework/mmdetection/data/VOCdevkit/coco/test2017/2007_001698.jpg'  # 或者 img = mmcv.imread(img)，这样图片仅会被读一次
img = '/work/jpma/chenxr/homework/mmdetection/data/VOCdevkit/coco/test2017/2007_000333.jpg/'  # 或者 img = mmcv.imread(img)，这样图片仅会被读一次
